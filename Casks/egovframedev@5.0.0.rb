cask "egovframedev@5.0.0" do
  ...
  url "https://maven.egovframe.go.kr/publist/HDD1/public/egovframework_v5.0/2_DevelopmentEnvironment/eGovFrame-Dev/5.0.0/eGovFrameDev-#{version}-macOS-#{arch}.dmg", user_agent: :fake
  name "eGovFrameDev"
